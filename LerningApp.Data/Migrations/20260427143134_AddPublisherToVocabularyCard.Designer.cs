...
namespace LerningApp.Data.Migrations
{
    ...
    [Migration("20260427143134_AddPublisherToVocabularyCard")]
    partial class AddPublisherToVocabularyCard
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LerningApp.Data.Models.MultipleChoiceExerciseOption", b =>
                {
                    ...
                    b.Property<Guid>("MultipleChoiceExerciseId")
                        .HasColumnType("uniqueidentifier")
                        .HasComment("Foreign key to the MultipleChoiceExercise");
            ...
            modelBuilder.Entity("LerningApp.Data.Models.Teacher", b =>
                {
                    ...
                    b.Property<bool>("HasProfileChangesPendingReview")
                        .HasColumnType("bit");

                    b.Property<string>("PendingBiography")
                        .HasMaxLength(2000)
                        .HasColumnType("nvarchar(2000)");
                    ...
                    b.Property<string>("PendingProfileImage")
                        .HasMaxLength(350)
                        .HasColumnType("nvarchar(350)");

                    b.Property<string>("PendingQualification")
                        .HasMaxLength(2000)
                        .HasColumnType("nvarchar(2000)");
                    ...
                    b.Property<DateTime?>("TeacherSince")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("LerningApp.Data.Models.VocabularyCard", b =>
                {
                    ...
                    b.Property<Guid>("PublisherId")
                        .HasColumnType("uniqueidentifier")
                        .HasComment("The Publisher of the Card");
            ...
            modelBuilder.Entity("LerningApp.Data.Models.VocabularyCard", b =>
                {
                    ...
                    b.HasOne("LerningApp.Data.Models.Teacher", "Publisher")
                        .WithMany("CreatedVocabularyCards")
                        .HasForeignKey("PublisherId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("LerningApp.Data.Models.Teacher", b =>
                {
                    ...
                    b.Navigation("CreatedVocabularyCards");

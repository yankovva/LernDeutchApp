...
namespace LerningApp.Data.Migrations
{
    ...
    [Migration("20260324161340_AddMultipleChoiceQuestionAndOption")]
    partial class AddMultipleChoiceQuestionAndOption
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LerningApp.Data.Models.ApplicationRole", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("LerningApp.Data.Models.MultipleChoiceExerciseOption", b =>
                {
                    ...
                    b.Property<Guid>("MultipleChoiceQuestionId")
                        .HasColumnType("uniqueidentifier")
                        .HasComment("Foreign key to the MultipleChoise Question");
                    ...
                    b.HasIndex("MultipleChoiceQuestionId", "OrderIndex")
                        .IsUnique();

                    b.ToTable("MultipleChoiceExerciseOptions");
                });

            modelBuilder.Entity("LerningApp.Data.Models.MultipleChoiceQuestion", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("MultipleChoiceExerciseId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("LerningApp.Data.Models.MultipleChoiceExerciseOption", b =>
                {
                    b.HasOne("LerningApp.Data.Models.MultipleChoiceQuestion", "MultipleChoiceQuestion")
                        .WithMany("Options")
            ...
            modelBuilder.Entity("LerningApp.Data.Models.MultipleChoiceQuestion", b =>
                {
                    b.HasOne("LerningApp.Data.Models.MultipleChoiceExercise", "MultipleChoiceExercise")
                        .WithMany("Questions")
            ...
            modelBuilder.Entity("LerningApp.Data.Models.UserLessonProgress", b =>
                {
                    b.HasOne("LerningApp.Data.Models.Lesson", "Lesson")
                        .WithMany("UsersLessonProgresses")
                        .HasForeignKey("LessonId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("LerningApp.Data.Models.ApplicationUser", "User")
                        .WithMany("UserLessonsProgresses")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<System.Guid>", b =>
                {
                    b.HasOne("LerningApp.Data.Models.ApplicationRole", null)
                        .WithMany()

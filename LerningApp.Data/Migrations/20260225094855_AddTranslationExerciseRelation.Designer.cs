...
namespace LerningApp.Data.Migrations
{
    ...
    [Migration("20260225094855_AddTranslationExerciseRelation")]
    partial class AddTranslationExerciseRelation
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LerningApp.Data.Models.MultipleChoiceExercise", b =>
                {
                    ...
                    b.Property<int>("OrderIndex")
                        .HasColumnType("int")
                        .HasComment("The order of the exercise");
            ...
            modelBuilder.Entity("LerningApp.Data.Models.TranslationExercise", b =>
                {
                    ...
                    b.Property<int>("ChosenTranslationLanguage")
                        .HasColumnType("int")
                        .HasComment("The chosen translation language option bg / en");

                    b.Property<string>("CorrectTranslation")
                        .IsRequired()
                        .HasMaxLength(300)
                        .HasColumnType("nvarchar(300)")
                        .HasComment("The correct translated sentence in the chosen language");
